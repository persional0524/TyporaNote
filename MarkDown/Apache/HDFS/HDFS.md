...
![图片](HDFS.assets/640-20210427093043801)            

**第二部分：读写故障的处理**

![图片](HDFS.assets/640-20210427093043396)

**第三部分：DataNode 故障处理**

![图片](HDFS.assets/640-20210427093043793)

**副本布局策略**：

![图片](HDFS.assets/640-20210427093043892)
...
1. **HDFS的写流程**
   ...
   **HDFS写流程**：
   ...
   4. 当一个block传输完成之后, Client再次请求NameNode上传第二个block，NameNode重新选择三台DataNode给Client。
      ...
      ![112_1.png](HDFS.assets/112_1.png)
